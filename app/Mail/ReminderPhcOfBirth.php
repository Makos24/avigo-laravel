...
class ReminderPhcOfBirth extends Mailable
{
    ...
    {
        return $this->view('emails.reminder-phc-of-birth')
        ->text('emails.reminder-phc-of-birth-plaintext')
        ->subject('Albarka New Birth Notification Reminder');
    }
}
